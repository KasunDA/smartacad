...
//Ajax Data Table
function setTableDatatablesAjax(table, url) {
    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": url// "/orders/all-data?" + condition // ajax source
                },
                "ordering": false,
                "order": [
                    [1, "asc"]
        ...
        // $('#'+table+' .dataTables_filter input').addClass("form-control input-medium input-inline"); // modify table search input
