...
$(function () {
    $('.add_class_room').click(function(e){
        e.preventDefault();
        var clone_row = $('#class_room_table tbody tr:last-child').clone();

        $('#class_room_table tbody').append(clone_row);
...
var TableManaged = function () {
    var initTable1 = function () {
        ...
        var tableWrapper = jQuery('#class_room_table_wrapper');
