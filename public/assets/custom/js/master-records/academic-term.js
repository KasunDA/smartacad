...
$(function () {
    ...
    $('.add_academic_term').click(function(e){
        ...
        clone_row.children(':last-child').html('<button class="btn btn-danger btn-rounded btn-condensed btn-xs remove_academic_term"><span class="fa fa-times"></span> Remove</button>');
    });
