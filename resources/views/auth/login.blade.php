        ...
        <div class="col-md-6 login-container bs-reset">
            <div class="login-content">
                ...
                <form action="{{ url('/auth/login') }}" class="login-form" method="post">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <input class="form-control form-control-solid placeholder-no-fix form-group" value="{{ old('email') }}" type="email" autocomplete="off" placeholder="Email" name="email" required/> </div>
                        <div class="col-xs-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 text-right">
                            <div class="forgot-password">
                                <a href="{{ url('auth/forget-password') }}" id="forget-password" class="forget-password">Forgot Password?</a>
                            </div>
