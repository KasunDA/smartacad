...
@section('title', 'Manage Menu Level Three')
...
@section('breadcrumb')
    ...
    <li><span class="active">Level Three</span></li>
@stop


@section('content')
    <!-- BEGIN PAGE BASE CONTENT -->
    <h3 class="page-title"> Manage Menu: Level Three</h3>
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-8 col-md-offset-2 margin-bottom-20 margin-top-20">
                <form method="post" action="/menus/filter" role="form" class="form-horizontal">
                    {!! csrf_field() !!}
                    {!! Form::hidden('level', 3, ['class'=>'form-control']) !!}
                            ...
                            <div class="col-md-9">
                                <select class="form-control selectpicker" name="menu_id" required>
                                    ...
                                    @foreach($filters as $child)
                                        ...
                                        @endif
                                    @endforeach
                                    <option value="all">ALL LEVEL THREE</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green bold uppercase">Menu Level Three</span>
                        </div>
                    </div>
...
@section('layout-script')
    ...
    <script>
        jQuery(document).ready(function () {
            setTabActive('[href="/menus/level-3"]');
        });
    </script>
@endsection