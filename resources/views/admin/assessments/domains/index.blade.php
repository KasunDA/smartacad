...
@section('title', 'Affective Domains / Remarks Assessments')
...
@section('breadcrumb')
    ...
    <li>
        <a href="{{ url('/domains') }}">Domains / Remarks</a>
...
@section('content')
    <h3 class="page">Affective Domains / Remarks Assessments</h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="portlet-body form">
                        <div class="tab-content">
                            <div class="tab-pane active" id="domains">
                                <div class="alert alert-info"> Search for <strong>Class Room Assigned</strong> To You For An <strong> Academic Term</strong></div>
                                {!! Form::open([
                                        'method'=>'POST',
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="portlet-body">
                                            <div class="row">
                                                <table class="table table-striped table-bordered table-hover" id="classroom_assigned_datatable">
    ...
    <script src="{{ asset('assets/custom/js/assessments/domain.js') }}" type="text/javascript"></script>
    <script>
