...
@section('content')
    <h3 class="page-title">Student Profile | Attendance Records</h3>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="attendance_tabledata">
                                            ...
                                            @foreach($attendances as $attendance)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('/attendances/details/'.$hashIds->encode($student->student_id)).'/'.$hashIds->encode($attendance->id) }}"
