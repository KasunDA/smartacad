...
@section('title', 'Terminal Student Exams Details')
...
@section('page-title')
    <h1> Terminal Student Exams Details</h1>
@endsection
                    ...
                    <div class="table-scrollable">
                        <table class="table table-hover table-striped">
                            ...
                            <tr>
                                <th> Student No. </th>
                                <td>
                                    <a target="_blank" href="{{ url('/wards/view/'.$hashIds->encode($student->student_id)) }}" class="btn btn-link btn-xs">
                                        {{ $student->student_no }}
                                    </a>
                                </td>
                                <th> Gender </th>
