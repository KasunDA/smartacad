                            ...
                            <tr>
                                <td class='movableContentContainer' align="center">
                                                                ...
                                                                <div class='contentEditableContainer contentImageEditable'>
                                                                    <div class='contentEditable'>
                                                                        <a target='_blank' href="{{ env('DEVELOPER_SITE_ADDRESS') }}"><img
                                                                                    src="{{ $message->embed(asset('/front/images/email/logo.png')) }}"
                                                                ...
                                                                <div class='contentEditableContainer contentTextEditable'>
                                                                    <div class='contentEditable'
                                                                        ...
                                                                        <h1 class='big'><a target='_blank'
                                                                                           href="{{ env('DEVELOPER_SITE_ADDRESS') }}"
                                                                                           style='color:#444444'>Gadafunds</a>
                                                                        </h1>
                                                                    </div>
                                                                </div>
                                                            </td>
                                    ...
                                    <div class='movableContent'>
                                        <table width="580" border="0" cellspacing="0" cellpadding="0" align="center">
                                            <tr>
                                                <td style='border-radius:6px;-moz-border-radius:6px;-webkit-border-radius:6px'>
                                                                ...
                                                                <div class='contentEditableContainer contentTextEditable'>
                                                                    <div class='contentEditable'
                                                                        ...
                                                                        <p style="color: #000000">
                                                                            Welcome to Gadafunds, the fastest growing
                                                                            crowd funding platform in Africa. We are so
                                                                            thrilled that you have decided to join the
                                                                            Gadafunds community either start a campaign
                                                                            or
                                                                            contribute to one.
                                                                        </p>
                                                                        ...
                                                                        <h2>
                                                                            <a class='link3'
                                                                           href="http://{{ env('DOMAIN_URL') }}/account/verify/{{ $hashIds->encode($user->id) }}/{{ $user->authentication_code }}">
                                                            ...
                                                            <td>
                                                                <div class='contentEditableContainer contentTextEditable'>
                                                                    <div class='contentEditable'
                                                                        ...
                                                                        <p>
                                                                            Sent by {{ env('APP_NAME') }}<br/>
                                                                            {{ env('DEVELOPER_SITE_ADDRESS') }} <br/>
                                                                            {{ env('DEVELOPER_SITE_NUMBER') }}<br/>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td width='40'>
                                                                <div class='contentEditableContainer contentFacebookEditable'>
                                                                    <div class='contentEditable'
                                                                         style='text-align: center;color:#AAAAAA;'>
                                                                        <a href="https://www.facebook.com/gadafunds/">
                                                                            <img src="{{ $message->embed(asset('/front/images/email/facebook.png')) }}"
                                                            ...
                                                            <td width='40'>
                                                                <div class='contentEditableContainer contentTwitterEditable'>
                                                                    <div class='contentEditable'
                                                                         style='text-align: center;color:#AAAAAA;'>
                                                                        <a href="https://www.twitter.com/gadafunds/">
                                                                            <img src="{{ $message->embed(asset('/front/images/email/twitter.png')) }}"
                                                            ...
                                                            <td width='40'>
                                                                <div class='contentEditableContainer contentImageEditable'>
                                                                    <div class='contentEditable'
                                                                         style='text-align: center;color:#AAAAAA;'>
                                                                        <a href="https://www.instagram.com/gadafunds/">
                                                                            <img src="{{ $message->embed(asset('/front/images/email/red.png')) }}"
                                                            ...
                                                            <td width='40'>
                                                                <div class='contentEditableContainer contentImageEditable'>
                                                                    <div class='contentEditable'
                                                                         style='text-align: center;color:#AAAAAA;'>
                                                                        <a href="https://www.linkedin.com/company/gadafunds-limited">
                                                                            <img src="{{ $message->embed(asset('/front/images/email/blue.png')) }}"
                                                                                 alt="Social media" width='40'
                                                                                 height='40'
                                                                                 data-max-width="40">
                                                                        </a>
                                                                    </div>
